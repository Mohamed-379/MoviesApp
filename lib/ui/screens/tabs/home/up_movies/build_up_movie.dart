...
class BuildUpMovie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, DetailsScreen.routeName, arguments: resultsUp.id.toString());
      },
      child: Column(
        children: [
            ...
            children: [
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(6),
                  ...
                  Stack(children: [
                    CachedNetworkImage(
                      imageUrl: "$baseUrl${resultsUp.posterPath}",height: MediaQuery.of(context).size.height * .19,
