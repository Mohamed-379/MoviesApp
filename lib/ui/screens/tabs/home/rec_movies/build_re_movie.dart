...
class BuildReMovie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, DetailsScreen.routeName, arguments: resultsRe.id.toString());
      },
      child: Column(
        children: [
            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                    ...
                    Stack(children: [
                      CachedNetworkImage(
                        imageUrl: "$baseUrl${resultsRe.posterPath}",height: MediaQuery.of(context).size.height * .19,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(resultsRe.voteAverage!.toStringAsFixed(1),style: const TextStyle(fontSize: 11,color: Colors.white,fontWeight: FontWeight.w400),)
                    ],
                  ),
