    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          InkWell(
            onTap: () {
              Navigator.pushNamed(context, DetailsScreen.routeName, arguments: resultsSear.id.toString());
            },
            child: Row(
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(10),
                  child: CachedNetworkImage(imageUrl: "$baseUrl${resultsSear.posterPath}",
                    ...
                    errorWidget: (context, url, error) {
                      return const Center(child: Icon(Icons.error,color: Color.fromARGB(255, 253, 178, 38),),);
                    },
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("${DateTime.tryParse(resultsSear.releaseDate!)?.year??"".toString()}",
                        style: const TextStyle(fontSize: 13,color: Colors.white54, fontWeight: FontWeight.w500),),
                      const SizedBox(height: 8,),
                      Row(
                        children: [
                          const Icon(Icons.star,color: Color.fromARGB(255, 251,
                              174, 31), size: 16),
                          const SizedBox(width: 4,),
                          Text(resultsSear.voteAverage!.toStringAsFixed(1),style: const TextStyle(color: Colors.white, fontSize: 13),)
                        ],
                      )
                    ],
                  ),
