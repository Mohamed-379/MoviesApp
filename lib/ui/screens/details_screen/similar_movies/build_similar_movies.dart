                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(simResults.voteAverage!.toStringAsFixed(1),style: const TextStyle(fontSize: 11,color: Colors.white,fontWeight: FontWeight.w400),)
                      ],
                    ),
                    const SizedBox(height: 3,),
                    SizedBox(width: 200,child: Text(simResults.title??"",
